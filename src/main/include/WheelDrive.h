...
class WheelDrive {
   public:
    ...
    WheelDrive(int angleMotorPort, int speedMotorPort, int encoderPort);
    ...
    double getAngleRad(double offset);
    void resetEncoder();
   ...
   private:
    ...
    frc2::PIDController pidController{DriveConstants::P, DriveConstants::I,
                                      DriveConstants::D};
    frc2::PIDController initializeController{
        DriveConstants::Pinit, DriveConstants::Iinit, DriveConstants::Dinit};
};
