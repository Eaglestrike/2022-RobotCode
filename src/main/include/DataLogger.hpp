...
public:
    ...
    float_t& get_float32(const std::string& key) { return m_float32_data[key]; }
    double_t& get_float64(const std::string& key) { return m_float64_data[key]; }
...
private:
    ...
    std::unordered_map<std::string, float_t>    m_float32_data;
    std::unordered_map<std::string, double_t>   m_float64_data;
};
