/* History:
  ...
  Purpose: 
  Swerve Drive file
  Uses 4 wheeldrive ~ swerve module class to control movement

  Has auto drive, robot or field oriented and incorporates
  odometry
*/
...
SwerveDrive::GenerateTrajectory_1(){
    ...
    Trajectory::Waypoint p1(1.4 * 0.304801, 0, 0, 0);
...
SwerveDrive::GenerateTrajectory_2(){
     m_trajectory_1.clearTrajectory();
    // 2 ball auto
    Trajectory::Waypoint p1(2.1, 0.0, 0, 0);
    m_trajectory_1.addWaypoint(p1);
}
...
SwerveDrive::GenerateTrajectory_3(){
    m_trajectory_1.clearTrajectory();
    // 3 ball auto
    Trajectory::Waypoint p1(1.25*0.304801, 0.15*0.304801, 0, 0);
    Trajectory::Waypoint p2(0, 0, 0, -110);
    Trajectory::Waypoint p3(4.2*0.304801, 0.6*0.304801, 0, 0); // 0.3 doesn't go enough in library testing to the right
...
SwerveDrive::GenerateTrajectory_5(){
    ...
    Trajectory::Waypoint p1(1.25*0.304801, 0.15*0.304801, 0, 0);
    Trajectory::Waypoint p2(0, 0, 0, -110);
    Trajectory::Waypoint p3(4.2*0.304801, 0.9*0.304801, 0, 0);
    Trajectory::Waypoint p4(0, 0, 0, 40);
    Trajectory::Waypoint p5(7.3*0.304801, 2.0*0.304801, 0, 0);
    Trajectory::Waypoint p6(4.0*0.304801, 1.3*0.304801, 0, 0);
    m_trajectory_1.addWaypoint(p1);
    m_trajectory_1.addWaypoint(p2);
    m_trajectory_1.addWaypoint(p3);  
    m_trajectory_1.addWaypoint(p4);
...
// For absolute encoder reading from CanCoders
void
