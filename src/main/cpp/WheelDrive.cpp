/* History:
  ...
  Purpose: 
  To represent a swerve module
  has the angle & speed motor, and encoder

  PID Controllers control movement
*/
...
WheelDrive::getVelocity(){
    return speedMotor.GetSelectedSensorVelocity()/2048 * (1/6.12) * 10 * PI * 0.1016;
}
...
// Stop All movement on the swerve module
void
WheelDrive::Stop(){
